	...
	for _, version := range virtualMachineVersions {
		...
		case "v1alpha1":
			...
			err = vmoperatorv1alpha1.Convert_v1alpha1_VirtualMachineList_To_v1alpha5_VirtualMachineList(
				vmAlpha1List, vmList, nil)
			if err != nil {
				log.Fatal("Error converting v1alpha1 VirtualMachineList to v1alpha5:", err)
			}
		case "v1alpha2":
			vmAlpha2List := &vmoperatorv1alpha2.VirtualMachineList{}
			err := clt.List(ctx, vmAlpha2List, client.InNamespace(namespace))
			...
			err = vmoperatorv1alpha2.Convert_v1alpha2_VirtualMachineList_To_v1alpha5_VirtualMachineList(
				vmAlpha2List, vmList, nil)
			if err != nil {
				log.Fatalf("Error converting v1alpha2 VirtualMachineList to v1alpha5: %s", err)
			}
		case "v1alpha3":
			vmAlpha3List := &vmoperatorv1alpha3.VirtualMachineList{}
			err := clt.List(ctx, vmAlpha3List, client.InNamespace(namespace))
			...
			err = vmoperatorv1alpha3.Convert_v1alpha3_VirtualMachineList_To_v1alpha5_VirtualMachineList(
				vmAlpha3List, vmList, nil)
			if err != nil {
				log.Fatal("Error converting v1alpha3 VirtualMachineList to v1alpha5: ", err)
			}
		case "v1alpha4":
			vmAlpha4List := &vmoperatorv1alpha4.VirtualMachineList{}
			...
			err = vmoperatorv1alpha4.Convert_v1alpha4_VirtualMachineList_To_v1alpha5_VirtualMachineList(
				vmAlpha4List, vmList, nil)
			if err != nil {
				log.Fatal("Error converting v1alpha4 VirtualMachineList to v1alpha5: ", err)
			}
		default:
			err := clt.List(ctx, vmList, client.InNamespace(namespace))
			if err != nil {
				log.Error("failed listing VirtualMachine resources for v1alpha5:", err)
				return nil, err
			}
		}
	}
